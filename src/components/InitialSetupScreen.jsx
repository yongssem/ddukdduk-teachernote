...
export default function InitialSetupScreen({ onComplete }) {
  ...
  if (step === 0) {
    return (
      <div className="min-h-dvh flex items-center justify-center p-6">
        <div className="bg-card/90 backdrop-blur-md rounded-[24px] shadow-lg p-8 max-w-sm w-full text-center space-y-4">
  ...
  return (
    <div className="min-h-dvh flex items-center justify-center p-6">
      <div className="bg-card/90 backdrop-blur-md rounded-[24px] shadow-lg p-6 max-w-sm w-full space-y-5">
